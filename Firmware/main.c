    ...
    while (1)
    {
        ...
        if (opAmpInterrupt == 1)
        {
            ...
            if (outRange == 0)
            {
                ...
                double distance =
                    (kTIM2CycleSeconds * (double)cycles * (double)kSpeedOfSound * (double)kConvertMM) / 2.0;
...
void initializeI2C(void)
{
    ...
    I2C_DeInit(I2C1);
    I2C_Init(I2C1, kI2CSpeed, getAddr(), I2C_Mode_I2C, I2C_DutyCycle_2, I2C_Ack_Enable, I2C_AcknowledgedAddress_7bit);
...
/*
 * @brief Enables and configures timers two, three, and four used for distance calculations, trigger timeout, and
 * enabling the op-amp respectively.
 * @param  None
 * @retval None
 */
