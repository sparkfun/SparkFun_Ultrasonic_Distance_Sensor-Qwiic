 ...
 694  0084 c650b2        	ld	a,20658
 695  0087 a420          	and	a,#32
 696  0089 6b01          	ld	(OFST-1,sp),a
 ...
 706  0092 0d01          	tnz	(OFST-1,sp)
 707  0094 270a          	jreq	L513
 709  0096 0d02          	tnz	(OFST+0,sp)
 710  0098 2706          	jreq	L513
 711                     ; 322     bitstatus = (ITStatus)SET;
 713  009a a601          	ld	a,#1
 714  009c 6b02          	ld	(OFST+0,sp),a
 717  009e 2002          	jra	L713
 718  00a0               L513:
 719                     ; 326     bitstatus = (ITStatus)RESET;
 721  00a0 0f02          	clr	(OFST+0,sp)
 723  00a2               L713:
 724                     ; 328   return ((ITStatus)bitstatus);
 726  00a2 7b02          	ld	a,(OFST+0,sp)
 729  00a4 85            	popw	x
 730  00a5 81            	ret
 754                     ; 336 void PWR_PVDClearITPendingBit(void)
 754                     ; 337 {
 755                     	switch	.text
 756  00a6               _PWR_PVDClearITPendingBit:
 760                     ; 339   PWR->CSR1 |= PWR_CSR1_PVDIF;
 762  00a6 721a50b2      	bset	20658,#5
 763                     ; 340 }
 766  00aa 81            	ret
 779                     	xdef	_PWR_PVDClearITPendingBit
 780                     	xdef	_PWR_PVDClearFlag
 781                     	xdef	_PWR_GetFlagStatus
 782                     	xdef	_PWR_PVDGetITStatus
 783                     	xdef	_PWR_PVDITConfig
 784                     	xdef	_PWR_UltraLowPowerCmd
 785                     	xdef	_PWR_FastWakeUpCmd
 786                     	xdef	_PWR_PVDCmd
 787                     	xdef	_PWR_PVDLevelConfig
 788                     	xdef	_PWR_DeInit
 807                     	end
