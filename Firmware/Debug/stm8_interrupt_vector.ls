 ...
 148                     	xdef	__vectab
 149                     	xref	f_I2C1_SPI2_IRQHandler
 150                     	xref	f_TIM4_UPD_OVF_TRG_IRQHandler
 151                     	xref	f_TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQHandler
 152                     	xref	f_TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQHandler
 153                     	xref	f_EXTI6_IRQHandler
 154                     	xref	f_EXTI5_IRQHandler
 155                     	xref	f_EXTI3_IRQHandler
 156                     	xref	f_NonHandledInterrupt
 157                     	xref	__stext
 158                     	end
